...
public class ClientHandler extends Thread{
    ...
    /**
     * Does the necessary stuff to play a ch card and makes this player's board activate the card's power
     * @throws Exception if the board cannot play the ch card
     */
